...
c       $log: gen_bl_file.for,v $
c revision 1.3  1995/09/13  21:35:19  birk
c added disclaimer to files
c
c revision 1.2  1994/04/25  17:05:38  birk
c reactivated this module that writes output for lsx (surface analysis)
c the current version should be fully portable between platforms.  the
c file that is written is in ascii
c
c revision 1.1  1994/04/25  15:17:46  birk
c initial revision
c
