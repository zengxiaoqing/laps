...
C
      DIMENSION WATR(4,2,260),XMVD(4),ICLD(8),ICTP(4),ICP(4)
      CHARACTER*70 TITLE
...
C
      ...
      CHARACTER*10 SCRCLR,ANSWER
      CHARACTER*8 CURPOS
      CHARACTER*4 SCRBLK,HUNITS(2),TUNITS(3),PUNITS(2)
      CHARACTER*3 LERASE
      CHARACTER*1 NUM(10),ANS,ANS2
C
