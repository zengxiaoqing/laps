     ...
     &(c_type(1:n).eq.'4u') )lvd_index =2

      if( (c_type(1:n).eq.'wv').or.(c_type(1:n).eq.'iwv'))
     &lvd_index=3

      if( (c_type(1:n).eq.'ir').or.
     &(c_type(1:n).eq.'ir '))lvd_index=4

      if((c_type(1:n).eq.'i11').or.
     &(c_type(1:n).eq.'11u'))lvd_index=4

      if( (c_type(1:n).eq.'12').or.(c_type(1:n).eq.'i12')
     &.or.(c_type(1:n).eq.'12u')   )lvd_index =5
