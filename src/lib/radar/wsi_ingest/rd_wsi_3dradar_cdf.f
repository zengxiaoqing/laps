     ...
     &radsPerLine,radsPerElem,la1,lo1,validTime,dataLevel,
     ...
     .   dx,dy,la1,lo1,centerlon,radsPerLine,radsPerElem,
     .   num_levels,data_levels,level_prefix,image,validTime,
     .   istatus)
...
C
     ...
     +   num_levels, validTime
      real Dx,Dy,La1,La2,Lo1,Lo2,centerLon,diffLon,radsPerElem, 
     +   radsPerLine, topLat

      call read_cdf_wsi3d_head(cfname,dataLevel, Dx, Dy,
     +    La1, La2, Lo1, Lo2, Nx, Ny, centerLon, data_levels,
...
C
C  Subroutine to read the file "WSI NEXRAD Data" 
C
