...
! --------------------
  ...
  REAL          :: W3(FCSTGRD(1),FCSTGRD(2),FCSTGRD(3),3)	! 3D WIND: UV
...
! --------------------
  ...
  ! CORRECED BY YUANFU FEB. 2008:
  CALL WIND_POST_PROCESS(I4,W3(1,1,1,1),W3(1,1,1,2),W3(1,1,1,3), &
                          FCSTGRD(1),FCSTGRD(2),FCSTGRD(3),3,HT, &
                          SF(1,1,1),SF(1,1,2),TP,LA,LO,DS,RM,.TRUE.,ST)
GOTO 1
  ! ADD WIND LAPS OUTPUT BY YUANFU FEB. 2008:
  CALL WRITE_WIND_OUTPUT(I4,'lw3',WN,W3(1,1,1,1),W3(1,1,1,2),W3(1,1,1,3), &
                         SF(1,1,1),SF(1,1,2),FCSTGRD(1),FCSTGRD(2),FCSTGRD(3),&
                         3,RM,ST)
