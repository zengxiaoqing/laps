  ...
  IF(NUMGRID(1).GE.2.AND.NUMGRID(2).GE.2.AND.NUMGRID(3).GE.3.AND.NUMSTAT.GE.3)THEN
    ...
    DO I=1,NUMGRID(1)
      ...
      GS=((GRDANALS(I2,J,K,T,PP)-GRDANALS(I1,J,K,T,PP)+GRDBKGND(I2,J,K,T,PP)-GRDBKGND(I1,J,K,T,PP)) &
         ...
         *(ZZZ(I2,J,K,T)-ZZZ(I1,J,K,T))/(XXX(I2,J)-XXX(I1,J)))*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DCOSD(DEG(I,J)) &
        -((GRDANALS(I,J2,K,T,PP)-GRDANALS(I,J1,K,T,PP)+GRDBKGND(I,J2,K,T,PP)-GRDBKGND(I,J1,K,T,PP)) &
         /(YYY(I,J2)-YYY(I,J1)) &
         -(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ) &
         *(ZZZ(I,J2,K,T)-ZZZ(I,J1,K,T))/(YYY(I,J2)-YYY(I,J1)))*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DSIND(DEG(I,J)) &
  ...
  IF(NUMGRID(1).GE.2.AND.NUMGRID(2).GE.2.AND.NUMGRID(3).GE.3.AND.NUMSTAT.GE.3)THEN
    ...
    DO I=1,NUMGRID(1)
      ...
      GS=((GRDANALS(I,J2,K,T,PP)-GRDANALS(I,J1,K,T,PP)+GRDBKGND(I,J2,K,T,PP)-GRDBKGND(I,J1,K,T,PP)) &
         ...
         -(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ) &
         *(ZZZ(I,J2,K,T)-ZZZ(I,J1,K,T))/(YYY(I,J2)-YYY(I,J1)))*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DCOSD(DEG(I,J)) &
        +((GRDANALS(I2,J,K,T,PP)-GRDANALS(I1,J,K,T,PP)+GRDBKGND(I2,J,K,T,PP)-GRDBKGND(I1,J,K,T,PP)) &
         /(XXX(I2,J)-XXX(I1,J)) &
         -(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ) &
         *(ZZZ(I2,J,K,T)-ZZZ(I1,J,K,T))/(XXX(I2,J)-XXX(I1,J)))*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DSIND(DEG(I,J)) &
...
!
      GRADINT(I2,J,K,T,PP)=GRADINT(I2,J,K,T,PP)+2.0*PNLT_PV*GS*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         /(XXX(I2,J)-XXX(I1,J))
!
      GRADINT(I1,J,K,T,PP)=GRADINT(I1,J,K,T,PP)+2.0*PNLT_PV*GS*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         /(XXX(I2,J)-XXX(I1,J))*(-1.0)
!
      GRADINT(I,J,K1,T,PP)=GRADINT(I,J,K1,T,PP)+2.0*PNLT_PV*GS*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         *AZ*(-1.0)*(ZZZ(I2,J,K,T)-ZZZ(I1,J,K,T))/(XXX(I2,J)-XXX(I1,J))
!
      GRADINT(I,J,K2,T,PP)=GRADINT(I,J,K2,T,PP)+2.0*PNLT_PV*GS*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         *BZ*(-1.0)*(ZZZ(I2,J,K,T)-ZZZ(I1,J,K,T))/(XXX(I2,J)-XXX(I1,J))
!
      GRADINT(I,J,K3,T,PP)=GRADINT(I,J,K3,T,PP)+2.0*PNLT_PV*GS*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         *CZ*(-1.0)*(ZZZ(I2,J,K,T)-ZZZ(I1,J,K,T))/(XXX(I2,J)-XXX(I1,J))
!
      GRADINT(I,J2,K,T,PP)=GRADINT(I,J2,K,T,PP)-2.0*PNLT_PU*GS*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DSIND(DEG(I,J)) &
                         /(YYY(I,J2)-YYY(I,J1))
!
      GRADINT(I,J1,K,T,PP)=GRADINT(I,J1,K,T,PP)-2.0*PNLT_PU*GS*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DSIND(DEG(I,J)) &
                         /(YYY(I,J2)-YYY(I,J1))*(-1.0)
!
      GRADINT(I,J,K1,T,PP)=GRADINT(I,J,K1,T,PP)-2.0*PNLT_PU*GS*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DSIND(DEG(I,J)) &
                         *AZ*(-1.0)*(ZZZ(I,J2,K,T)-ZZZ(I,J1,K,T))/(YYY(I,J2)-YYY(I,J1))
!
      GRADINT(I,J,K2,T,PP)=GRADINT(I,J,K2,T,PP)-2.0*PNLT_PU*GS*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DSIND(DEG(I,J)) &
                         *BZ*(-1.0)*(ZZZ(I,J2,K,T)-ZZZ(I,J1,K,T))/(YYY(I,J2)-YYY(I,J1))
!
      GRADINT(I,J,K3,T,PP)=GRADINT(I,J,K3,T,PP)-2.0*PNLT_PU*GS*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DSIND(DEG(I,J)) &
...
!
      GRADINT(I,J2,K,T,PP)=GRADINT(I,J2,K,T,PP)+2.0*PNLT_PU*GS*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         /(YYY(I,J2)-YYY(I,J1))
!
      GRADINT(I,J1,K,T,PP)=GRADINT(I,J1,K,T,PP)+2.0*PNLT_PU*GS*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         /(YYY(I,J2)-YYY(I,J1))*(-1.0)
!
      GRADINT(I,J,K1,T,PP)=GRADINT(I,J,K1,T,PP)+2.0*PNLT_PU*GS*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         *AZ*(-1.0)*(ZZZ(I,J2,K,T)-ZZZ(I,J1,K,T))/(YYY(I,J2)-YYY(I,J1))
!
      GRADINT(I,J,K2,T,PP)=GRADINT(I,J,K2,T,PP)+2.0*PNLT_PU*GS*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         *BZ*(-1.0)*(ZZZ(I,J2,K,T)-ZZZ(I,J1,K,T))/(YYY(I,J2)-YYY(I,J1))
!
      GRADINT(I,J,K3,T,PP)=GRADINT(I,J,K3,T,PP)+2.0*PNLT_PU*GS*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         *CZ*(-1.0)*(ZZZ(I,J2,K,T)-ZZZ(I,J1,K,T))/(YYY(I,J2)-YYY(I,J1))
!
      GRADINT(I2,J,K,T,PP)=GRADINT(I2,J,K,T,PP)+2.0*PNLT_PV*GS*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DSIND(DEG(I,J)) &
                         /(XXX(I2,J)-XXX(I1,J))
!
      GRADINT(I1,J,K,T,PP)=GRADINT(I1,J,K,T,PP)+2.0*PNLT_PV*GS*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DSIND(DEG(I,J)) &
                         /(XXX(I2,J)-XXX(I1,J))*(-1.0)
!
      GRADINT(I,J,K1,T,PP)=GRADINT(I,J,K1,T,PP)+2.0*PNLT_PV*GS*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DSIND(DEG(I,J)) &
                         *AZ*(-1.0)*(ZZZ(I2,J,K,T)-ZZZ(I1,J,K,T))/(XXX(I2,J)-XXX(I1,J))
!
      GRADINT(I,J,K2,T,PP)=GRADINT(I,J,K2,T,PP)+2.0*PNLT_PV*GS*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DSIND(DEG(I,J)) &
                         *BZ*(-1.0)*(ZZZ(I2,J,K,T)-ZZZ(I1,J,K,T))/(XXX(I2,J)-XXX(I1,J))
!
      GRADINT(I,J,K3,T,PP)=GRADINT(I,J,K3,T,PP)+2.0*PNLT_PV*GS*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DSIND(DEG(I,J)) &
                         *CZ*(-1.0)*(ZZZ(I2,J,K,T)-ZZZ(I1,J,K,T))/(XXX(I2,J)-XXX(I1,J))
!
    ENDDO
    ENDDO
  ...
  IF(NUMGRID(1).GE.2.AND.NUMGRID(2).GE.2.AND.NUMGRID(3).GE.3.AND.NUMSTAT.GE.3)THEN
    ...
    DO I=1,NUMGRID(1)
      ...
      GS=(GRDANALS(I2,J,K,T,PP)-GRDANALS(I1,J,K,T,PP)+GRDBKGND(I2,J,K,T,PP)-GRDBKGND(I1,J,K,T,PP)) &
        /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
         +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ) &
        /(XXX(I2,J)-XXX(I1,J))*SCP(PSL)/SCP(XSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DCOSD(DEG(I,J)) &
        -(GRDANALS(I,J2,K,T,PP)-GRDANALS(I,J1,K,T,PP)+GRDBKGND(I,J2,K,T,PP)-GRDBKGND(I,J1,K,T,PP)) &
        /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
         +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ) &
        /(YYY(I,J2)-YYY(I,J1))*SCP(PSL)/SCP(YSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DSIND(DEG(I,J)) &
        +COR(I,J)*DEN(I,J,K,T)*(GRDANALS(I,J,K,T,VV)+GRDBKGND(I,J,K,T,VV))
      COSTFUN=COSTFUN+PNLT_PV*GS**2
    ENDDO
    ENDDO
  ...
  IF(NUMGRID(1).GE.2.AND.NUMGRID(2).GE.2.AND.NUMGRID(3).GE.3.AND.NUMSTAT.GE.3)THEN
    ...
    DO I=1,NUMGRID(1)
      ...
      GS=(GRDANALS(I,J2,K,T,PP)-GRDANALS(I,J1,K,T,PP)+GRDBKGND(I,J2,K,T,PP)-GRDBKGND(I,J1,K,T,PP)) &
        /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
         +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ) &
        /(YYY(I,J2)-YYY(I,J1))*SCP(PSL)/SCP(YSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DCOSD(DEG(I,J)) &
        +(GRDANALS(I2,J,K,T,PP)-GRDANALS(I1,J,K,T,PP)+GRDBKGND(I2,J,K,T,PP)-GRDBKGND(I1,J,K,T,PP)) &
        /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
         +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ) &
        /(XXX(I2,J)-XXX(I1,J))*SCP(PSL)/SCP(XSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DSIND(DEG(I,J)) &
        -COR(I,J)*DEN(I,J,K,T)*(GRDANALS(I,J,K,T,UU)+GRDBKGND(I,J,K,T,UU))
      COSTFUN=COSTFUN+PNLT_PU*GS**2
    ENDDO
    ENDDO
...
!
      GRADINT(I2,J,K,T,PP)=GRADINT(I2,J,K,T,PP)+2.0*PNLT_PV*GS*SCP(PSL)/SCP(XSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DCOSD(DEG(I,J)) &
	                     /(XXX(I2,J)-XXX(I1,J)) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)
!
      GRADINT(I1,J,K,T,PP)=GRADINT(I1,J,K,T,PP)+2.0*PNLT_PV*GS*SCP(PSL)/SCP(XSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*(-1.0)*DCOSD(DEG(I,J)) &
                         /(XXX(I2,J)-XXX(I1,J)) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)
!
      GRADINT(I,J,K1,T,PP)=GRADINT(I,J,K1,T,PP)+2.0*PNLT_PV*GS*SCP(PSL)/SCP(XSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DCOSD(DEG(I,J)) &
...
!
      GRADINT(I,J,K2,T,PP)=GRADINT(I,J,K2,T,PP)+2.0*PNLT_PV*GS*SCP(PSL)/SCP(XSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         *(GRDANALS(I2,J,K,T,PP)-GRDANALS(I1,J,K,T,PP) &
                          +GRDBKGND(I2,J,K,T,PP)-GRDBKGND(I1,J,K,T,PP))/(XXX(I2,J)-XXX(I1,J))*BZ*(-1.0) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)**2
!
      GRADINT(I,J,K3,T,PP)=GRADINT(I,J,K3,T,PP)+2.0*PNLT_PV*GS*SCP(PSL)/SCP(XSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         *(GRDANALS(I2,J,K,T,PP)-GRDANALS(I1,J,K,T,PP) &
                          +GRDBKGND(I2,J,K,T,PP)-GRDBKGND(I1,J,K,T,PP))/(XXX(I2,J)-XXX(I1,J))*CZ*(-1.0) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)**2
!
      GRADINT(I,J2,K,T,PP)=GRADINT(I,J2,K,T,PP)-2.0*PNLT_PU*GS*SCP(PSL)/SCP(YSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DSIND(DEG(I,J)) &
                         /(YYY(I,J2)-YYY(I,J1)) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)
!
      GRADINT(I,J1,K,T,PP)=GRADINT(I,J1,K,T,PP)-2.0*PNLT_PU*GS*SCP(PSL)/SCP(YSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*(-1.0)*DSIND(DEG(I,J)) &
                         /(YYY(I,J2)-YYY(I,J1)) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)
!
      GRADINT(I,J,K1,T,PP)=GRADINT(I,J,K1,T,PP)-2.0*PNLT_PU*GS*SCP(PSL)/SCP(YSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DSIND(DEG(I,J)) &
                         *(GRDANALS(I,J2,K,T,PP)-GRDANALS(I,J1,K,T,PP) &
                          +GRDBKGND(I,J2,K,T,PP)-GRDBKGND(I,J1,K,T,PP))/(YYY(I,J2)-YYY(I,J1))*AZ*(-1.0) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)**2
!
      GRADINT(I,J,K2,T,PP)=GRADINT(I,J,K2,T,PP)-2.0*PNLT_PU*GS*SCP(PSL)/SCP(YSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DSIND(DEG(I,J)) &
                         *(GRDANALS(I,J2,K,T,PP)-GRDANALS(I,J1,K,T,PP) &
                          +GRDBKGND(I,J2,K,T,PP)-GRDBKGND(I,J1,K,T,PP))/(YYY(I,J2)-YYY(I,J1))*BZ*(-1.0) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)**2
!
      GRADINT(I,J,K3,T,PP)=GRADINT(I,J,K3,T,PP)-2.0*PNLT_PU*GS*SCP(PSL)/SCP(YSL)/SCP(CSL)/SCL(VV)/SCP(DSL)*DSIND(DEG(I,J)) &
                         *(GRDANALS(I,J2,K,T,PP)-GRDANALS(I,J1,K,T,PP) &
...
!
      GRADINT(I,J2,K,T,PP)=GRADINT(I,J2,K,T,PP)+2.0*PNLT_PU*GS*SCP(PSL)/SCP(YSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         /(YYY(I,J2)-YYY(I,J1)) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)
!
      GRADINT(I,J1,K,T,PP)=GRADINT(I,J1,K,T,PP)+2.0*PNLT_PU*GS*SCP(PSL)/SCP(YSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*(-1.0)*DCOSD(DEG(I,J)) &
                         /(YYY(I,J2)-YYY(I,J1)) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)
!
      GRADINT(I,J,K1,T,PP)=GRADINT(I,J,K1,T,PP)+2.0*PNLT_PU*GS*SCP(PSL)/SCP(YSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         *(GRDANALS(I,J2,K,T,PP)-GRDANALS(I,J1,K,T,PP) &
                          +GRDBKGND(I,J2,K,T,PP)-GRDBKGND(I,J1,K,T,PP))/(YYY(I,J2)-YYY(I,J1))*AZ*(-1.0) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)**2
!
      GRADINT(I,J,K2,T,PP)=GRADINT(I,J,K2,T,PP)+2.0*PNLT_PU*GS*SCP(PSL)/SCP(YSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         *(GRDANALS(I,J2,K,T,PP)-GRDANALS(I,J1,K,T,PP) &
                          +GRDBKGND(I,J2,K,T,PP)-GRDBKGND(I,J1,K,T,PP))/(YYY(I,J2)-YYY(I,J1))*BZ*(-1.0) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)**2
!
      GRADINT(I,J,K3,T,PP)=GRADINT(I,J,K3,T,PP)+2.0*PNLT_PU*GS*SCP(PSL)/SCP(YSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DCOSD(DEG(I,J)) &
                         *(GRDANALS(I,J2,K,T,PP)-GRDANALS(I,J1,K,T,PP) &
                          +GRDBKGND(I,J2,K,T,PP)-GRDBKGND(I,J1,K,T,PP))/(YYY(I,J2)-YYY(I,J1))*CZ*(-1.0) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)**2
!
      GRADINT(I2,J,K,T,PP)=GRADINT(I2,J,K,T,PP)+2.0*PNLT_PV*GS*SCP(PSL)/SCP(XSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DSIND(DEG(I,J)) &
	                     /(XXX(I2,J)-XXX(I1,J)) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)
!
      GRADINT(I1,J,K,T,PP)=GRADINT(I1,J,K,T,PP)+2.0*PNLT_PV*GS*SCP(PSL)/SCP(XSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*(-1.0)*DSIND(DEG(I,J)) &
                         /(XXX(I2,J)-XXX(I1,J)) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)
!
      GRADINT(I,J,K1,T,PP)=GRADINT(I,J,K1,T,PP)+2.0*PNLT_PV*GS*SCP(PSL)/SCP(XSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DSIND(DEG(I,J)) &
                         *(GRDANALS(I2,J,K,T,PP)-GRDANALS(I1,J,K,T,PP) &
                          +GRDBKGND(I2,J,K,T,PP)-GRDBKGND(I1,J,K,T,PP))/(XXX(I2,J)-XXX(I1,J))*AZ*(-1.0) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)**2
!
      GRADINT(I,J,K2,T,PP)=GRADINT(I,J,K2,T,PP)+2.0*PNLT_PV*GS*SCP(PSL)/SCP(XSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DSIND(DEG(I,J)) &
                         *(GRDANALS(I2,J,K,T,PP)-GRDANALS(I1,J,K,T,PP) &
                          +GRDBKGND(I2,J,K,T,PP)-GRDBKGND(I1,J,K,T,PP))/(XXX(I2,J)-XXX(I1,J))*BZ*(-1.0) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)**2
!
      GRADINT(I,J,K3,T,PP)=GRADINT(I,J,K3,T,PP)+2.0*PNLT_PV*GS*SCP(PSL)/SCP(XSL)/SCP(CSL)/SCL(UU)/SCP(DSL)*DSIND(DEG(I,J)) &
                         *(GRDANALS(I2,J,K,T,PP)-GRDANALS(I1,J,K,T,PP) &
                          +GRDBKGND(I2,J,K,T,PP)-GRDBKGND(I1,J,K,T,PP))/(XXX(I2,J)-XXX(I1,J))*CZ*(-1.0) &
                         /(GRDANALS(I,J,K1,T,PP)*AZ+GRDANALS(I,J,K2,T,PP)*BZ+GRDANALS(I,J,K3,T,PP)*CZ &
                          +GRDBKGND(I,J,K1,T,PP)*AZ+GRDBKGND(I,J,K2,T,PP)*BZ+GRDBKGND(I,J,K3,T,PP)*CZ)**2
...
! --------------------
  ...
  IF(NUMGRID(1).GE.2.AND.NUMGRID(2).GE.2.AND.NUMGRID(3).GE.3.AND.NUMSTAT.GE.3)THEN
    ...
    DO I=1,NUMGRID(1)
      ...
      J2=MIN0(J+1,NUMGRID(2))
      GS=(GRDANALS(I2,J,K,T,PP)-GRDANALS(I1,J,K,T,PP)+GRDBKGND(I2,J,K,T,PP)-GRDBKGND(I1,J,K,T,PP)) &
        /(XXX(I2,J)-XXX(I1,J))*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(VV)*GA*DCOSD(DEG(I,J)) &
        -(GRDANALS(I,J2,K,T,PP)-GRDANALS(I,J1,K,T,PP)+GRDBKGND(I,J2,K,T,PP)-GRDBKGND(I,J1,K,T,PP)) &
        /(YYY(I,J2)-YYY(I,J1))*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(VV)*GA*DSIND(DEG(I,J)) &
  ...
  IF(NUMGRID(1).GE.2.AND.NUMGRID(2).GE.2.AND.NUMGRID(3).GE.3.AND.NUMSTAT.GE.3)THEN
    ...
    DO I=1,NUMGRID(1)
      ...
      J2=MIN0(J+1,NUMGRID(2))
      GS=(GRDANALS(I,J2,K,T,PP)-GRDANALS(I,J1,K,T,PP)+GRDBKGND(I,J2,K,T,PP)-GRDBKGND(I,J1,K,T,PP)) &
        /(YYY(I,J2)-YYY(I,J1))*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(UU)*GA*DCOSD(DEG(I,J)) &
        +(GRDANALS(I2,J,K,T,PP)-GRDANALS(I1,J,K,T,PP)+GRDBKGND(I2,J,K,T,PP)-GRDBKGND(I1,J,K,T,PP)) &
        /(XXX(I2,J)-XXX(I1,J))*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(UU)*GA*DSIND(DEG(I,J)) &
...
!
      GRADINT(I2,J,K,T,PP)=GRADINT(I2,J,K,T,PP)+2.0*PNLT_PV*GS*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(VV)*DCOSD(DEG(I,J)) &
	                     /(XXX(I2,J)-XXX(I1,J))*GA
!
      GRADINT(I1,J,K,T,PP)=GRADINT(I1,J,K,T,PP)+2.0*PNLT_PV*GS*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(VV)*(-1.0)*DCOSD(DEG(I,J)) &
                         /(XXX(I2,J)-XXX(I1,J))*GA
!
      GRADINT(I,J2,K,T,PP)=GRADINT(I,J2,K,T,PP)-2.0*PNLT_PU*GS*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(VV)*DSIND(DEG(I,J)) &
                         /(YYY(I,J2)-YYY(I,J1))*GA
!
      GRADINT(I,J1,K,T,PP)=GRADINT(I,J1,K,T,PP)-2.0*PNLT_PU*GS*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(VV)*(-1.0)*DSIND(DEG(I,J)) &
                         /(YYY(I,J2)-YYY(I,J1))*GA
!
    ENDDO
    ENDDO
...
!
      GRADINT(I,J2,K,T,PP)=GRADINT(I,J2,K,T,PP)+2.0*PNLT_PU*GS*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(UU)*DCOSD(DEG(I,J)) &
                         /(YYY(I,J2)-YYY(I,J1))*GA
!
      GRADINT(I,J1,K,T,PP)=GRADINT(I,J1,K,T,PP)+2.0*PNLT_PU*GS*SCL(PP)/SCP(YSL)/SCP(CSL)/SCL(UU)*(-1.0)*DCOSD(DEG(I,J)) &
                         /(YYY(I,J2)-YYY(I,J1))*GA
!
      GRADINT(I2,J,K,T,PP)=GRADINT(I2,J,K,T,PP)+2.0*PNLT_PV*GS*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(UU)*DSIND(DEG(I,J)) &
	                     /(XXX(I2,J)-XXX(I1,J))*GA
!
      GRADINT(I1,J,K,T,PP)=GRADINT(I1,J,K,T,PP)+2.0*PNLT_PV*GS*SCL(PP)/SCP(XSL)/SCP(CSL)/SCL(UU)*(-1.0)*DSIND(DEG(I,J)) &
                         /(XXX(I2,J)-XXX(I1,J))*GA
!
    ENDDO
    ENDDO
...
!   FOR RADAR OBSERVATION
      ...
      DO I=NP(1),MIN0(NP(1)+1,NUMGRID(1))
        ...
        IF(K.GE.2)THEN
          ...
          Z2=PPP(K)
          DO K1=2,K
            GRADINT(I2,J,K1-1,T,UU)=GRADINT(I2,J,K1-1,T,UU)-CC*(Z2-Z1)/2.0/(XXX(I2,J)-XXX(I1,J))*SCP(PSL)/SCP(XSL)*DCOSD(DEG(I,J))
            GRADINT(I1,J,K1-1,T,UU)=GRADINT(I1,J,K1-1,T,UU)+CC*(Z2-Z1)/2.0/(XXX(I2,J)-XXX(I1,J))*SCP(PSL)/SCP(XSL)*DCOSD(DEG(I,J))
            GRADINT(I,J2,K1-1,T,VV)=GRADINT(I,J2,K1-1,T,VV)-CC*(Z2-Z1)/2.0/(YYY(I,J2)-YYY(I,J1))*SCP(PSL)/SCP(YSL)*DCOSD(DEG(I,J))
            GRADINT(I,J1,K1-1,T,VV)=GRADINT(I,J1,K1-1,T,VV)+CC*(Z2-Z1)/2.0/(YYY(I,J2)-YYY(I,J1))*SCP(PSL)/SCP(YSL)*DCOSD(DEG(I,J))
            GRADINT(I2,J,K1  ,T,UU)=GRADINT(I2,J,K1  ,T,UU)-CC*(Z2-Z1)/2.0/(XXX(I2,J)-XXX(I1,J))*SCP(PSL)/SCP(XSL)*DCOSD(DEG(I,J))
            GRADINT(I1,J,K1  ,T,UU)=GRADINT(I1,J,K1  ,T,UU)+CC*(Z2-Z1)/2.0/(XXX(I2,J)-XXX(I1,J))*SCP(PSL)/SCP(XSL)*DCOSD(DEG(I,J))
            GRADINT(I,J2,K1  ,T,VV)=GRADINT(I,J2,K1  ,T,VV)-CC*(Z2-Z1)/2.0/(YYY(I,J2)-YYY(I,J1))*SCP(PSL)/SCP(YSL)*DCOSD(DEG(I,J))
            GRADINT(I,J1,K1  ,T,VV)=GRADINT(I,J1,K1  ,T,VV)+CC*(Z2-Z1)/2.0/(YYY(I,J2)-YYY(I,J1))*SCP(PSL)/SCP(YSL)*DCOSD(DEG(I,J))
            GRADINT(I,J2,K1-1,T,UU)=GRADINT(I,J2,K1-1,T,UU)+CC*(Z2-Z1)/2.0/(YYY(I,J2)-YYY(I,J1))*SCP(PSL)/SCP(YSL)*DSIND(DEG(I,J))
            GRADINT(I,J1,K1-1,T,UU)=GRADINT(I,J1,K1-1,T,UU)-CC*(Z2-Z1)/2.0/(YYY(I,J2)-YYY(I,J1))*SCP(PSL)/SCP(YSL)*DSIND(DEG(I,J))
            GRADINT(I2,J,K1-1,T,VV)=GRADINT(I2,J,K1-1,T,VV)-CC*(Z2-Z1)/2.0/(XXX(I2,J)-XXX(I1,J))*SCP(PSL)/SCP(XSL)*DSIND(DEG(I,J))
            GRADINT(I1,J,K1-1,T,VV)=GRADINT(I1,J,K1-1,T,VV)+CC*(Z2-Z1)/2.0/(XXX(I2,J)-XXX(I1,J))*SCP(PSL)/SCP(XSL)*DSIND(DEG(I,J))
            GRADINT(I,J2,K1  ,T,UU)=GRADINT(I,J2,K1  ,T,UU)+CC*(Z2-Z1)/2.0/(YYY(I,J2)-YYY(I,J1))*SCP(PSL)/SCP(YSL)*DSIND(DEG(I,J))
            GRADINT(I,J1,K1  ,T,UU)=GRADINT(I,J1,K1  ,T,UU)-CC*(Z2-Z1)/2.0/(YYY(I,J2)-YYY(I,J1))*SCP(PSL)/SCP(YSL)*DSIND(DEG(I,J))
            GRADINT(I2,J,K1  ,T,VV)=GRADINT(I2,J,K1  ,T,VV)-CC*(Z2-Z1)/2.0/(XXX(I2,J)-XXX(I1,J))*SCP(PSL)/SCP(XSL)*DSIND(DEG(I,J))
            GRADINT(I1,J,K1  ,T,VV)=GRADINT(I1,J,K1  ,T,VV)+CC*(Z2-Z1)/2.0/(XXX(I2,J)-XXX(I1,J))*SCP(PSL)/SCP(XSL)*DSIND(DEG(I,J))
          ENDDO
        ENDIF
      ENDDO
      ENDDO
