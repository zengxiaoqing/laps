  ...
  IF(NUMGRID(1).GE.2.AND.NUMGRID(2).GE.2.AND.NUMGRID(3).GE.3.AND.NUMSTAT.GE.3)THEN
    ...
    DO I=1,NUMGRID(1)
      ...
      GS=((GRDANALS(I2,J,K,T,3)-GRDANALS(I1,J,K,T,3)+GRDBKGND(I2,J,K,T,3)-GRDBKGND(I1,J,K,T,3)) &
         ...
         *(ZZZ(I2,J,K,T)-ZZZ(I1,J,K,T))/(XXX(I2,J)-XXX(I1,J)))*SCP(3)/SCP(1)/SCP(4)/SCL(2)/SCP(5)*DCOSD(DEG(I,J)) &
        -((GRDANALS(I,J2,K,T,3)-GRDANALS(I,J1,K,T,3)+GRDBKGND(I,J2,K,T,3)-GRDBKGND(I,J1,K,T,3)) &
         /(YYY(I,J2)-YYY(I,J1)) &
         -(GRDANALS(I,J,K1,T,3)*AZ+GRDANALS(I,J,K2,T,3)*BZ+GRDANALS(I,J,K3,T,3)*CZ &
          +GRDBKGND(I,J,K1,T,3)*AZ+GRDBKGND(I,J,K2,T,3)*BZ+GRDBKGND(I,J,K3,T,3)*CZ) &
         *(ZZZ(I,J2,K,T)-ZZZ(I,J1,K,T))/(YYY(I,J2)-YYY(I,J1)))*SCP(3)/SCP(2)/SCP(4)/SCL(2)/SCP(5)*DSIND(DEG(I,J)) &
  ...
  IF(NUMGRID(1).GE.2.AND.NUMGRID(2).GE.2.AND.NUMGRID(3).GE.3.AND.NUMSTAT.GE.3)THEN
    ...
    DO I=1,NUMGRID(1)
      ...
      GS=((GRDANALS(I,J2,K,T,3)-GRDANALS(I,J1,K,T,3)+GRDBKGND(I,J2,K,T,3)-GRDBKGND(I,J1,K,T,3)) &
         ...
         -(GRDANALS(I,J,K1,T,3)*AZ+GRDANALS(I,J,K2,T,3)*BZ+GRDANALS(I,J,K3,T,3)*CZ &
          +GRDBKGND(I,J,K1,T,3)*AZ+GRDBKGND(I,J,K2,T,3)*BZ+GRDBKGND(I,J,K3,T,3)*CZ) &
         *(ZZZ(I,J2,K,T)-ZZZ(I,J1,K,T))/(YYY(I,J2)-YYY(I,J1)))*SCP(3)/SCP(2)/SCP(4)/SCL(1)/SCP(5)*DCOSD(DEG(I,J)) &
        +((GRDANALS(I2,J,K,T,3)-GRDANALS(I1,J,K,T,3)+GRDBKGND(I2,J,K,T,3)-GRDBKGND(I1,J,K,T,3)) &
         /(XXX(I2,J)-XXX(I1,J)) &
         -(GRDANALS(I,J,K1,T,3)*AZ+GRDANALS(I,J,K2,T,3)*BZ+GRDANALS(I,J,K3,T,3)*CZ &
          +GRDBKGND(I,J,K1,T,3)*AZ+GRDBKGND(I,J,K2,T,3)*BZ+GRDBKGND(I,J,K3,T,3)*CZ) &
         *(ZZZ(I2,J,K,T)-ZZZ(I1,J,K,T))/(XXX(I2,J)-XXX(I1,J)))*SCP(3)/SCP(1)/SCP(4)/SCL(1)/SCP(5)*DSIND(DEG(I,J)) &
...
!
      GRADINT(I2,J,K,T,3)=GRADINT(I2,J,K,T,3)+2.0*PNLT_PV*GS*SCP(3)/SCP(1)/SCP(4)/SCL(2)/SCP(5)*DCOSD(DEG(I,J)) &
                         /(XXX(I2,J)-XXX(I1,J))
!
      GRADINT(I1,J,K,T,3)=GRADINT(I1,J,K,T,3)+2.0*PNLT_PV*GS*SCP(3)/SCP(1)/SCP(4)/SCL(2)/SCP(5)*DCOSD(DEG(I,J)) &
...
!
      GRADINT(I,J2,K,T,3)=GRADINT(I,J2,K,T,3)-2.0*PNLT_PU*GS*SCP(3)/SCP(2)/SCP(4)/SCL(2)/SCP(5)*DSIND(DEG(I,J)) &
                         /(YYY(I,J2)-YYY(I,J1))
!
      GRADINT(I,J1,K,T,3)=GRADINT(I,J1,K,T,3)-2.0*PNLT_PU*GS*SCP(3)/SCP(2)/SCP(4)/SCL(2)/SCP(5)*DSIND(DEG(I,J)) &
...
!
      GRADINT(I,J2,K,T,3)=GRADINT(I,J2,K,T,3)+2.0*PNLT_PU*GS*SCP(3)/SCP(2)/SCP(4)/SCL(1)/SCP(5)*DCOSD(DEG(I,J)) &
                         /(YYY(I,J2)-YYY(I,J1))
!
      GRADINT(I,J1,K,T,3)=GRADINT(I,J1,K,T,3)+2.0*PNLT_PU*GS*SCP(3)/SCP(2)/SCP(4)/SCL(1)/SCP(5)*DCOSD(DEG(I,J)) &
                         /(YYY(I,J2)-YYY(I,J1))*(-1.0)
!
...
!
      GRADINT(I2,J,K,T,3)=GRADINT(I2,J,K,T,3)+2.0*PNLT_PV*GS*SCP(3)/SCP(1)/SCP(4)/SCL(1)/SCP(5)*DSIND(DEG(I,J)) &
                         /(XXX(I2,J)-XXX(I1,J))
!
      GRADINT(I1,J,K,T,3)=GRADINT(I1,J,K,T,3)+2.0*PNLT_PV*GS*SCP(3)/SCP(1)/SCP(4)/SCL(1)/SCP(5)*DSIND(DEG(I,J)) &
                         /(XXX(I2,J)-XXX(I1,J))*(-1.0)
!
