...
cdis*/
#ifndef	LINT
static char rtapelib[] = "@(#)rtapelib.c	2.1	2/15/95";
#endif	/* LINT */
...
/*
 *	Changes made by Kevin W. Thomas at the National Severe Storms Lab
 *	to make the routines compatible with the TPIO library.
 */
...
#include "rmtdefs.h"			/* definitions...kwt */
...
/* Open a magtape device on the system specified in PATH, as the given user.
   ...
   (Original source had "?" instead of "#", but Sun acc screams about some
   "trigraph" trouble.)
...
#ifdef	MTIOCGET		/* IBM doesn't have it. */
