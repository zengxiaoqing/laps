...
50    format(1x,a,10(:,a3,1x))
     ...
     + n_radars,c_radar_ext,c_radar_mosaic,i_window,mosaic_cycle_time,
     + imosaic_3d,istatus)
...
1000  stop
     ...
     & n_radars,c_radar_ext,c_mosaic_type,i_window_size,
     & mosaic_cycle_time,imosaic_3d,
     & istatus)
c
...
!            Read 'vxx' file within 300s tolerance of 'i4time_mos'
