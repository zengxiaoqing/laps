...
c*********************************************************************
c
      real pgot,tss,pbok,tss,pbot,pgok
      integer sc(m,n)
c
...
c
c
         Subroutine reorder(ta,tda,dda,ffa,lata,lona,
     &        eleva,pstna,pmsla,alta,stna,
...
c
      icnt=icnt+1 
      iiiii=icnt
      iiiii=ran(iiiii)*20000000.-10000000.
      on=1
      off=0
...
c zero out scoring arraYs
      ...
      enddo !j
      enddo !i
      call score(TdT,XT,Y,x,b,imax,scf,sca,scb,thresh,qcstat,m,badflag)
