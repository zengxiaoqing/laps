...
!==============================================================================
  ...
  INTEGER*4, INTENT(IN) :: I4OBSTIME(*)			! I4 OBS TIMES
...
!==============================================================================
  ...
  INTEGER*4, INTENT(IN) :: HHMINTIME(*)			! I4 OBS TIMES

  ! OBSERVATIONS:
  REAL*4,    INTENT(IN) :: LATITUDES(*),LONGITUDE(*),ELEVATION(*)
  REAL*4,    INTENT(IN) :: MSLPRSOBS(*), &		! MEAN SEA LEVEL PRESSURE
                           MSLPRSERR(*), &		! ERROR
