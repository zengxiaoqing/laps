...
!==============================================================================
  ...
  INTEGER   :: I,J,K,INDATE,ZEROCH,STATUS,OBTIME(6)
  ...
  DO I=1,NUMPROFLR
    ...
    DO J=1,NUMLEVELS(I)
      IF (HEIGHTOBS(I,J) .NE. RVALUE_MISSING .AND. &
        ...
        WRITE(TMGOUT_CHANNEL,11) RI,RJ,RK,TEMPTROBS(I,J),OBSVNTYPE(I)
...
!==============================================================================
  ...
  ! OBSERVATIONS:
  REAL,      INTENT(IN) :: LATITUDES(*),LONGITUDE(*),ELEVATION(*)
  REAL,      INTENT(IN) :: HEIGHTOBS(MAXNUM_SONDES,*), &	! UPAIR (M)
  ...
  DO I=1,NUMSONDES
    ...
    CASE ('DROPSND')
      ...
      HEADER(3) = 31            ! INPUT REPORT TYPE: TABLE 6: SATELLITE-DERIVED WIND
      OBSERR(1,1:NUMLEVELS(I)) = 0.0    ! ZERO ERROR FOR HEIGHT
      OBSERR(3,1:NUMLEVELS(I)) = 2.0    ! ASSUME 2 DEG ERROR
      OBSERR(4,1:NUMLEVELS(I)) = 1.0    ! 2 M/S ERROR ASSUMED FOR SATWIND
      OBSERR(6,1:NUMLEVELS(I)) = 2.0    ! ASSUME 2 MM ERROR
...
!==============================================================================
  ...
  ! LOCAL VARIABLES:
  CHARACTER :: STTNID*8,SUBSET*8
  INTEGER   :: I,K,INDATE,ZEROCH,STATUS,OBTIME(6)
  INTEGER   :: I4TIME
...
!==============================================================================
  ...
  DO I=1,NUMBEROBS
    ...
    IF (OBSVARRAY(7,I) .NE. RVALUE_MISSING) THEN
      OBSDAT(3) = OBSVARRAY(7,I)-ABSOLU_TMPZERO	

      ! SAVE TEMPERATURE OBS INTO TMG FILE:
      WRITE(TMGOUT_CHANNEL,11) RI,RJ,RK,OBSVARRAY(7,I),STTNID
11    FORMAT(3f10.4,f10.3,3x,a8)
    ENDIF
