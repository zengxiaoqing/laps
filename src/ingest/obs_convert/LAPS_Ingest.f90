...
!==============================================================================
  ...
  INTEGER*4 :: I4TIME,OBTIME(MAXNUM_PROFLRS)
...
!==============================================================================
  ...
  INTEGER   :: IOFILE,STATUS,NPRFLR,NLEVEL(MAXNUM_PROFLRS), &
               WINDOW,MODEOB
  INTEGER*4 :: I4TIME,PRFTIM(MAXNUM_PROFLRS,MAXLVL_PROFLRS)
...
!==============================================================================
  ...
  INTEGER*4,   ALLOCATABLE,DIMENSION(:) :: OBTIME,WMOIDS! OBS TIME/WMO ID
  INTEGER*4,   ALLOCATABLE,DIMENSION(:) :: CLDLYR,PRSCHC! CLOUD LAYER/PRS CHG
  ...
  REAL*4,      ALLOCATABLE,DIMENSION(:,:) :: CLDHGT	! CLOUD HEIGHTS
  REAL*4,      ALLOCATABLE,DIMENSION(:,:) :: OBSWND, &  ! OBS WIND
