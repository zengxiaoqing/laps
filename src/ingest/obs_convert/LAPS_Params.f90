...
!==============================================================================
!  THIS ROUTINE DEFINES ALL PARAMETERS REQUIRED FOR LAPS.
!
!  HISTORY:
!	CREATION:	YUANFU XIE	MAY 2007
!==============================================================================
  ...
  REAL,         PARAMETER :: TEMPTR_REFEREN=-132.0
  ...
  INTEGER*4   :: SYSTEM_IN4TIME		! I4 SYSTEM TIME
  ...
  INTEGER*4   :: THRESH_RADAROB(3)	! THRESHOLD NUMBERS DOPPLER OBS/LEVEL
					! BY FACTOR 2,4,9
