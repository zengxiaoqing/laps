...
c
c this is true as of 2/16/98
c     integer    n_parms
c     parameter (n_parms=58)
...
5     format(1x,'SAT_RANGE_M=',2(1x,f11.2,','))               !maxsat = 2
...
33    format(1x,'J_END_VIS=',8(i5,','))
34    format(1x,'I_START_IR=',8(i5,','))
35    format(1x,'I_END_IR=',8(i5,','))
36    format(1x,'J_START_IR=',8(i5,','))
37    format(1x,'J_END_IR=',8(i5,','))
38    format(1x,'I_START_WV=',8(i5,','))
39    format(1x,'I_END_WV=',8(i5,','))
40    format(1x,'J_START_WV=',8(i5,','))
41    format(1x,'J_END_WV=',8(i5,','))
42    format(1x,'N_PIXELS_VIS=',8(i5,','))
43    format(1x,'N_LINES_VIS=',8(i5,','))
44    format(1x,'N_PIXELS_IR=',8(i5,','))
45    format(1x,'N_LINES_IR=',8(i5,','))
46    format(1x,'N_PIXELS_WV=',8(i5,','))
47    format(1x,'N_LINES_WV=',8(i5,','))
48    format(1x,'I_EWCYCLES=',8(i5,','))
49    format(1x,'I_EWINCS=',8(i5,','))
50    format(1x,'I_NSCYCLES=',8(i5,','))
51    format(1x,'I_NSINCS=',8(i5,','))
52    format(1x,'I_NWLINE_VIS=',8(i5,','))
53    format(1x,'I_NWLINE_IR=',8(i5,','))
54    format(1x,'I_NWLINE_WV=',8(i5,','))
